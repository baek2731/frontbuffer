...
- excerpt 인코딩 깨짐 발생 → 강제 롤백으로 복구 (8/13)
...
### 일일 루틴 (15~20분)
**매일:** Quora 1~2개 답변 (링크는 3~4개 중 1개에만)
**주 1~2회:** Dev.to 글 발행 (canonical URL 필수), HN 제출
**XDA:** 링크 없이 순수 답변 3~5개 먼저, 1주 후 링크 포함
...
| 4 | Reddit 워밍업 | 지속 |
| 5 | SEO excerpt 재작업 | 다음 세션 (em dash → 하이픈으로 교체) |
| 6 | 중복 글 처리 | 다음 세션 (sitemap:false + canonical 방식) |

### 중복 글 현황
| 글 | 중복 대상 | 처리 방법 |
|---|---|---|
| 8/2 실리콘카본 EXPLAINER | 8/5 실리콘카본 EXPLAINER | sitemap:false + canonical |
| 8/11 Android Auto 어댑터 COMPARISON | 8/8 Android Auto 어댑터 COMPARISON | sitemap:false + canonical |
